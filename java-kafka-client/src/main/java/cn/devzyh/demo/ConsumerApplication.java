...
public class ConsumerApplication {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < consumerNum; i++) {
            ...
            subscribedTopics.add("apac.supply.salesorder.953ab20.v1");
    ...
    public synchronized static Properties loadProperties() {
        ...
        try {
            kafkaProperties.load(ConsumerApplication.class.getClassLoader().getResourceAsStream("kafka.properties"));
        } catch (Exception e) {
            //没加载到文件，程序要考虑退出
            e.printStackTrace();
        }
